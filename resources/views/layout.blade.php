...
<head>
  ...
  <title>@yield('meta_title', 'Cargo365')</title>
  <meta name="description" content="@yield('meta_description', 'Cargo365')">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav py-2 mx-auto-">
          ...
          @foreach($pages as $page)
            <li class="nav-item">
              <a class="nav-link px-3 text-white" aria-current="page" href="/i/{{ $page->slug }}">{{ $page->title }}</a>
            </li>
          @endforeach
          @auth
            <li class="nav-item">
              <a class="nav-link px-3 text-white" aria-current="page" href="/{{ $lang }}/client">Мои треки</a>
            </li>
          @endauth
        </ul>
        <div class="ms-auto">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="container">
      ...
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 text-muted">© {{ date('Y') }} Cargo365</span>
      </div>
