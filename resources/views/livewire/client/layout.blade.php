...
<body class="bg-light">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-brand bg-brand-border" aria-label="Main navigation">
    <div class="container-xl">
      <a href="/{{ $lang }}/client" class="navbar-brand">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav py-2 mx-auto-">
          ...
          <li class="nav-item">
            <a class="nav-link px-3 text-white" href="/{{ $lang }}/profile">Мой аккаунт</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-3 text-white" href="/{{ $lang }}/client">Мои треки</a>
          </li>
          <li class="nav-item">
            <a class="nav-link px-3 text-white" href="/{{ $lang }}/client/archive">Мой архив</a>
          </li>
        </ul>
